...
#define MyAppName "Rigel Dome X2 PlugIn"
...
OutputBaseFilename=RigelDome_X2_Installer
...
[Files]
Source: "domelist RigelDome.txt";                       DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist RigelDome.txt";                       DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 RigelDome.txt"
; 32 bits
Source: "libRigelDome\Win32\Release\libRigelDome.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "RigelDome.ui";                                 DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "Pulsar.png";                                   DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libRigelDome\x64\Release\libRigelDome.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "RigelDome.ui";                                 DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "Pulsar.png";                                   DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
